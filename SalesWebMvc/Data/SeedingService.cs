...
namespace SalesWebMvc.Data
{
    ...
    {
        //Registrar dependencia Db context com SeedingService
        //Propriedade
        ...
        public void Seed()
        {
            //Testar dse tem registro na base de dados
            ...
            //Se não existir, popular banco de dados
            //Instanciar os objetos Department
            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            //Instanciar os objetos Vendedores
            ...
            //AddRange -> Adicionar varios objetos de uma só vez
